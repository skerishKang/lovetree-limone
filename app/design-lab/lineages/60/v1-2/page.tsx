    ...
    >
      ...
      >
        ...
        <Contract
          ...
          body="Track55 → /v4/trees/demo/graph (resolved). Track56 → /design-lab/lineages/53/v2 (resolved). Track59 → /design-lab/lineages/59/v5 (resolved). No file://, source-relative HTML or window.open to local source files — no fake navigation PASS."
        />
      </section>
    </main>
  );
