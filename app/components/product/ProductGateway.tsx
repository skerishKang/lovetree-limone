    ...
    <main className="lt-gateway">
      ...
      <section className="lt-gateway__hero" aria-labelledby="product-gateway-title">
        ...
        <p className="lt-gateway__lede">
          기존 제품은 그대로 보존하고, Next LoveTree에서는 새 디자인을 시나리오별 Variant로 계속 구현합니다.
        ...
        <Link className="lt-gateway__lab" href="/design-lab">
          <span>
            ...
            <em>{sourceCount}개 LoveTree 디자인 원본 · {EXPERIENCE_CAPABILITIES.length}개 교차프로젝트 Capability · 역사적 비교안</em>
          </span>
          <b>모든 후보와 패턴 비교하기 →</b>
        </Link>
      </section>
