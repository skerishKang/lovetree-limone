...
export const DESIGN_FIDELITY_TARGETS = Object.freeze([
  {
    ...
    impactPrefixes: [
      ...
      "lib/lineage-52",
      "old/reference/lineage-52",
      "public/old/reference/lineage-52",
  ...
  },
  {
    ...
    impactPrefixes: [
      ...
      "lib/lineage-53",
      "old/reference/lineage-53",
      "public/old/reference/lineage-53",
      "scripts/lineage-53",
      "tests/lineage-53",
  ...
  },
  {
    ...
    impactPrefixes: [
      ...
      "lib/lineage-54",
      "old/reference/lineage-54",
      "public/old/reference/lineage-54",
  ...
  },
  {
    ...
    impactPrefixes: [
      ...
      "lib/lineage-56",
      "old/reference/lineage-56",
      "public/old/reference/lineage-56",
  ...
  },
  {
    ...
    impactPrefixes: [
      ...
      "lib/lineage-57",
      "old/reference/lineage-57",
      "public/old/reference/lineage-57",
  ...
  },
  {
    ...
    impactPrefixes: [
      ...
      "old/reference/design-intake/track-61-guided-next-moment-builder/",
  ...
  },
  {
    ...
    impactPrefixes: [
      ...
      "lib/memory-anatomy",
      "old/reference/design-lab/capabilities/memory-anatomy/",
