...
export const DESIGN_FIDELITY_TARGETS = Object.freeze([
  ...
  {
    id: "source60-p0-fidelity",
    label: "Source60 P0 A/B/C Product Fidelity",
    ...
    assetGate: null,
    browserGates: ["qa/source60-p0-fidelity-browser-qa.mjs"],
    viewports: [
      { width: 1280, height: 800 },
      { width: 390, height: 844, mobile: true },
      { width: 320, height: 720, mobile: true },
    ...
    captureReducedMotion: true,
    extraEvidencePaths: ["qa/evidence/source60-p0"],
  },
  {
