...
export const SUPPLEMENTAL_DESIGN_FIDELITY_TARGETS = Object.freeze([
  ...
  Object.freeze({
    ...
    impactPrefixes: Object.freeze([
      ...
      "old/reference/lineage-55-moonlit-blossom-v1/",
      "public/old/reference/lineage-55-moonlit-blossom-v1/",
    ]),
  ...
  Object.freeze({
    ...
    impactPrefixes: Object.freeze([
      ...
      "old/reference/source-tracks-snapshot/36_시네마틱메모리포털_버전통합/",
  ...
  Object.freeze({
    ...
    impactPrefixes: Object.freeze([
      ...
      "old/reference/source-tracks-snapshot/24_영상기억_워크플로우/",
  ...
  Object.freeze({
    ...
    impactPrefixes: Object.freeze([
      ...
      "old/reference/source-tracks-snapshot/18_메모리코어_전기오로라/",
  ...
  Object.freeze({
    ...
    impactPrefixes: Object.freeze([
      ...
      "old/reference/source-tracks-snapshot/56_세로형_모먼트관계망_전체조망/",
    ]),
    assetGate: null,
  ...
  Object.freeze({
    ...
    impactPrefixes: Object.freeze([
      ...
      "public/old/reference/source-track-57-living-glass/",
...
export const EXPLICIT_MACHINE_CHECKED_EXCLUSIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    impactPrefixes: Object.freeze(["app/design-lab/source-tracks/38/v1/donor/", "lib/source-track-38/", "design-intake/manifests/source-track-38-voyager-space-memory-map-v1.json", "old/reference/source-tracks-snapshot/38_보이저_우주기억지도/", "qa/source-track-38-v1-discover-donor-browser-qa.mjs", "tests/source-track-38-v1-donor-contract.test.mjs", ".github/workflows/source-track38-v1-discover-donor-browser-qa.yml"]),
  ...
  Object.freeze({
    ...
    impactPrefixes: Object.freeze([
      ...
      "old/components/source-track-58/",
