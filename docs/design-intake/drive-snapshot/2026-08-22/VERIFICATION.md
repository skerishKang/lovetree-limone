...
PR #287은 기존 수입 계열 중 일부를 `reference/source-tracks-snapshot/`에 물리 중복 저장했다.
...
|---|---|---|
| 18 | `reference/source-tracks-snapshot/18_메모리코어_전기오로라/` (39,680 B) | `public/design-lab-assets/source-tracks/18/` |
| 55 | `reference/source-tracks-snapshot/55_자유연결_경로편집/` (55,456 B) | `reference/lineage-55-moonlit-blossom-v1/` |
| 56 | `reference/source-tracks-snapshot/56_세로형_모먼트관계망_전체조망/` (45,893 B) | `reference/lineage-56-crystal-memory-atelier-v3/` |
| 59 | `reference/source-tracks-snapshot/59_메모리스케치북_페이지여정/` (120,740 B) | `docs/lineage-59/` |
| 60 | `reference/source-tracks-snapshot/60_3D모먼트클러스터_심층탐색_55,56,59연결버전/` (55,424 B) | `design-intake/manifests/track-60-3d-moment-cluster.json` |
| 61 | `reference/source-tracks-snapshot/61_감정경로_연결검토실/` (509,149 B) | `reference/design-intake/track-61-guided-next-moment-builder/` |
| 64 | `reference/source-tracks-snapshot/64_부유모먼트_웰컴오빗_입장포털O/` (1,565,399 B) | `design-intake/manifests/track-64-floating-moment-entry-portal.json` |
| 66 | `reference/source-tracks-snapshot/66_첫트리만들기_인터랙티브스크롤가이드/` (167,138 B) | `design-intake/manifests/track-66-first-journey-v1-2.json` |
| 67 | `reference/source-tracks-snapshot/67_메모리테이프_인터랙티브롤/` (4,914,126 B) | `public/design-lab-assets/lineages/67/v2-4/` |
...
cd reference/source-tracks-snapshot
