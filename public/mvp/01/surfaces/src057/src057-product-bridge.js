...
(function () {
  ...
  function ensureProductEditFields() {
    try {
      ...
      wrap.innerHTML = '<div class="field"><label for="mvpTitleInput">제목</label>'
        + '<input id="mvpTitleInput" type="text" maxlength="120" autocomplete="off"></div>'
        + '<div class="field"><label for="mvpMemoInput">메모</label>'
