...
export const LINEAGE_INTAKE_CANDIDATES: readonly DesignCandidate[] = [
  ...
  {
    id: "lineage:lt-61-guided-next-moment-builder-61-v1-9",
    ...
    notes: "Native interaction candidate reuses V1.7 implementation. V1.9 source reconciled (prior V1.7 pin was stale). V1.9 scale/visual deltas NOT yet reimplemented — HOLD pending actual V1.9 Drive source. Central interaction-contract QA is required; P8/source fidelity and canonical /v4 adoption remain HOLD.",
  },
] as const;
