...
test("Track60 cross-track handoffs resolve to current repository routes", () => {
  ...
  const currentTargets = [
    ...
    [
      "Track56",
      "/design-lab/lineages/53/53-v3-vertical-network-overview",
      "app/design-lab/lineages/53/53-v3-vertical-network-overview/page.tsx",
    ],
  ...
  assert.ok(
    !pageSource.includes('href="/design-lab/lineages/53/v2"'),
    "Track56 no longer points to the superseded family handoff after Source56 adoption",
  );
});
